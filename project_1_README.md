...
<script type="text/javascript">
    sys_info = {"notebook_version": "5.7.0", "notebook_path": "/opt/conda/lib/python3.6/site-packages/notebook", "commit_source": "", "commit_hash": "", "sys_version": "3.6.3 | packaged by conda-forge | (default, Dec  9 2017, 04:28:46) \n[GCC 4.8.2 20140120 (Red Hat 4.8.2-15)]", "sys_executable": "/opt/conda/bin/python", "sys_platform": "linux", "platform": "Linux-4.15.0-1060-gcp-x86_64-with-debian-stretch-sid", "os_name": "posix", "default_encoding": "UTF-8"};
</script>

<script src="/static/components/text-encoding/lib/encoding.js?v=d5bb0fc9ffeff7d98a69bb83daa51052" charset="utf-8"></script>

<script src="/static/notebook/js/main.min.js?v=fc2a61bcf6f091823db7fb553a838e7f" type="text/javascript" charset="utf-8"></script>
